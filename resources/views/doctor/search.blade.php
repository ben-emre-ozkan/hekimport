                                ...
                                <div class="p-6">
                                    <div class="flex items-center justify-center mb-4">
                                        @if($doctor->profile_image)
                                            <img src="{{ asset('storage/' . $doctor->profile_image) }}" alt="{{ $doctor->name }}" class="w-24 h-24 rounded-full object-cover border-4 border-teal-100">
                                        @else
                                    ...
                                    <h3 class="text-lg font-semibold text-center mb-2">Dr. {{ $doctor->name }}</h3>
                                    <p class="text-gray-600 text-center mb-4">{{ $doctor->specialty }}</p>
                                    <div class="flex justify-center">
                                        <a href="{{ route('doctor.public-profile', $doctor) }}" class="bg-teal-500 hover:bg-teal-600 text-white px-4 py-2 rounded-full transition duration-300 ease-in-out transform hover:scale-105 shadow-md">
                                            Profili Görüntüle
                                        </a>
                                    </div>
                                </div>
